        ...
        <div class="wrapper">
            <div class="flex flex-wrap px-4 py-4">
                <div class="page__title w-1/2">
                    <router-link to="/job-openings/create" class="btn btn-success inline-block"><i class="fa fas fa-plus"></i></i> Post a Job</router-link>
                </div>
                <div class="page__title w-1/2">
                            ...
                            <div class="overflow-x-scroll xl:overflow-x-hidden lg:overflow-x-hidden md:overflow-x-hidden">
                                <vuetable ref="vuetable" 
                                    ...
                                    <div slot="Actions" slot-scope="props">
                                      <router-link :to="`job-openings/${props.rowData.id}/applicants`" :data-id="props.rowData.id" class="inline-block btn btn-info" title="Applicants"><i class="fa fa-users"></i></router-link>
                                      <router-link  :to="`/job-openings/${props.rowData.id}/edit`" :data-id="props.rowData.id" class="inline-block btn btn-success" title="Edit"><i class="fa fa-pencil"></i></router-link>
                                      <button :data-id="props.rowData.id" @click="deleteJob(props.rowData.id)" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></button>
                                    </div>
                                </vuetable>
                                <div>
